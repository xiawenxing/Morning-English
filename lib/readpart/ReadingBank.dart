...
class ReadingBank extends StatefulWidget{
  @override
  State<StatefulWidget> createState() =>new _ReadingBankState();

}
List<Widget> widgetList=new List();

class _ReadingBankState extends State<ReadingBank>{
  int _radioGroupA = 0;
                  ...
                  child: new ListView(
                    children: <Widget>[
                      new Container(
                        ...
                        padding: EdgeInsets.only(top: 20.0, left: 20.0, right: 20.0, bottom: 30),
                        child: new Text(
                          Globals.newsQuestion.questionContent,
                          textAlign: TextAlign.left,
                          style: TextStyle(color: Color(0xFF1E3E62), fontSize: 16.0, letterSpacing: 0.5, fontWeight: FontWeight.w300),
                        ),
                      ),
                      ...
                      new RadioListTile(
                        ...
                        title: Text(Globals.newsQuestion.wrongAnswer[0]),
                      ...
                      new RadioListTile(
                        ...
                        groupValue: _radioGroupA,
                        onChanged: _handleRadioValueChanged,
                        title: Text(Globals.newsQuestion.correctAnswer),
                      ...
                      new RadioListTile(
                        ...
                        groupValue: _radioGroupA,
                        onChanged: _handleRadioValueChanged,
                        title: Text(Globals.newsQuestion.wrongAnswer[1]),
                      ...
                      new RadioListTile(
                        ...
                        groupValue: _radioGroupA,
                        onChanged: _handleRadioValueChanged,
                        title: Text(Globals.newsQuestion.wrongAnswer[2]),
